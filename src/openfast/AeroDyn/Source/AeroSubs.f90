...
!FUNCTION AD_WindVelocityWithDisturbance( InputPosition, IElement, IBlade, ErrStat  )
...
!   INTEGER                    :: IElement
   ...
   !InflowVel = WindInf_GetVelocity( REAL(Time, ReKi), InputPosition, IElement, IBlade, Sttus)
