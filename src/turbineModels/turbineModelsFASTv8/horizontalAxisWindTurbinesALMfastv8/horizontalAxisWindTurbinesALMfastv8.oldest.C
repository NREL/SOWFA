...
{   
    ...
    // Send global and turbine-level inputs to FAST.
   ...
   List<int> nBladesFAST(numTurbines,0);
   nBladesFAST[Pstream::myProcNo()] = FAST.get_numBlades(0);
   Pstream::gather(nBladesFAST,sumOp<List<int> >());
   Pstream::scatter(nBladesFAST);

   List<int> nBladePointsFAST(numTurbines,0);
   nBladePointsFAST[Pstream::myProcNo()] = FAST.get_numNodesPerBlade(0);
   Pstream::gather(nBladePointsFAST,sumOp<List<int> >());
   Pstream::scatter(nBladePointsFAST);

   List<int> nTowerPointsFAST(numTurbines,0);
   nTowerPointsFAST[Pstream::myProcNo()] = FAST.get_numTwrNodes(0);
   Pstream::gather(nTowerPointsFAST,sumOp<List<int> >());
   Pstream::scatter(nTowerPointsFAST);
   
   Info << "nBladesFAST: " << nBladesFAST << endl;
   Info << "nBladePointsFAST: " << nBladePointsFAST << endl;
   Info << "nTowerPointsFAST: " << nTowerPointsFAST << endl;
...
/*---------------------------------------------------------------------------*\
    ...
    forAll(turbineName,i)
    {
       NumBl[i] = nBladesFAST[i];
       numBladePoints[i] = nBladePointsFAST[i];
       numTowerPoints[i] = nTowerPointsFAST[i];
    }
...
// * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * * //
void horizontalAxisWindTurbinesALMfastv8::getFASTpositions()
{
}


void horizontalAxisWindTurbinesALMfastv8::FASTupdate()
{
}


void horizontalAxisWindTurbinesALMfastv8::getFASTforces()
{
}
...
void horizontalAxisWindTurbinesALMfastv8::findRotorSearchCells(int turbineNumber)
{
...
void horizontalAxisWindTurbinesALMfastv8::findNacelleSearchCells(int turbineNumber)
{
    // Define the cells that can possibly be influenced by the force
...
void horizontalAxisWindTurbinesALMfastv8::findTowerSearchCells(int turbineNumber)
{
    // Define the cells that can possibly be influenced by the force
...
void horizontalAxisWindTurbinesALMfastv8::rotateBlades()
{  
...
void horizontalAxisWindTurbinesALMfastv8::yawNacelle()
{
    // Perform rotation turbine by turbine.
    forAll(uvTower, i)
    {
...
void horizontalAxisWindTurbinesALMfastv8::computeRotSpeed()
{
...
void horizontalAxisWindTurbinesALMfastv8::filterRotSpeed()
{
    // Proceed turbine by turbine.
...
void horizontalAxisWindTurbinesALMfastv8::controlGenTorque()
{
    // Proceed turbine by turbine.
...
void horizontalAxisWindTurbinesALMfastv8::controlNacYaw()
{
    // Proceed turbine by turbine.
...
void horizontalAxisWindTurbinesALMfastv8::controlBladePitch()
{
    // Proceed turbine by turbine.
    forAll(bladePitch, i)
    {
...
void horizontalAxisWindTurbinesALMfastv8::findBladePointControlProcNo()
{
...
void horizontalAxisWindTurbinesALMfastv8::findNacellePointControlProcNo()
{
    // Create a local and global list of minimum distance cells to velocity sampling 
    // points of turbines that this processor controls.  Initialize the values to huge.
...
void horizontalAxisWindTurbinesALMfastv8::findTowerPointControlProcNo()
{
    // Create a local and global list of minimum distance cells to velocity sampling 
    // points of turbines that this processor controls.  Initialize the values to huge.
...
void horizontalAxisWindTurbinesALMfastv8::computeBladePointWindVectors()
{
...
void horizontalAxisWindTurbinesALMfastv8::computeNacellePointWindVectors()
{
...
void horizontalAxisWindTurbinesALMfastv8::computeTowerPointWindVectors()
{
...
void horizontalAxisWindTurbinesALMfastv8::computeBladePointForce()
{
...
void horizontalAxisWindTurbinesALMfastv8::computeNacellePointForce()
{
...
void horizontalAxisWindTurbinesALMfastv8::computeTowerPointForce()
{
    // The tower nacelle wind vector is in the Cartesian coordinate system so no need
    // to transform it either.
...
void horizontalAxisWindTurbinesALMfastv8::computeBladeBodyForce()
{  
...
void horizontalAxisWindTurbinesALMfastv8::computeNacelleBodyForce()
{  
    // Initialize variables that are integrated forces.
...
void horizontalAxisWindTurbinesALMfastv8::computeTowerBodyForce()
{  
    // Initialize variables that are integrated forces.
